...
export default class ParameterRow extends Component {
  ...
  render() {
    let {param, rawParam, getComponent, getConfigs, isExecute, fn, onChangeConsumes, specSelectors, pathMethod, specPath, relEndpoint } = this.props
      ...
      <tr data-param-name={param.get("name")} data-param-in={param.get("in")}>
        ...
        <td className="col parameters-col_description">
...

          {
            ...
            :
              param.get("x-ntap-introduced") == "DO_NOT_DISPLAY"
              ?
                <p></p>
              :
                <p>{`Introduced in ${param.get("x-ntap-introduced")}`}</p>
          }
