...
export default class Auths extends React.Component {
  ...
  // NTAP Modification - auto-close the popup on successful login
  submitAuth =(e) => {
    e.preventDefault()

    let { definitions, authActions, authSelectors } = this.props
    ...
    if (authorizedAuth.size) {
      authActions.showDefinitions(false)
    }
  }

 // NTAP Modification - auto-close the popup on logout
 logoutClick =(e) => {
    e.preventDefault()
